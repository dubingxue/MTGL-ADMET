...
def generate_mol_feats(args, model, data_loader, dataset_output_path):
    ...
    with torch.no_grad():
        for batch_id, batch_data in enumerate(data_loader):
            ...
            feats = model(bg, atom_feats).numpy().tolist()
...
class EarlyStopping(object):
    ...
    def load_model_attention(self, model):
        pretrained_parameters = ['gnn_layers.0.graph_conv_layer.weight',
                                 ...
                                 'weighted_sum_readout.atom_weighting_specific.31.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.31.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.32.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.32.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.33.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.33.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.34.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.34.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.35.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.35.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.36.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.36.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.37.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.37.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.38.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.38.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.39.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.39.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.40.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.40.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.41.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.41.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.42.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.42.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.43.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.43.0.bias',
                                 'weighted_sum_readout.atom_weighting_specific.44.0.weight',
                                 'weighted_sum_readout.atom_weighting_specific.44.0.bias',
